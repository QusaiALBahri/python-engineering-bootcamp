...
- [Python Docs](https://docs.python.org/3/) — Core language reference
- [NumPy Guide](https://numpy.org/doc/) — Array operations
- [Pandas Guide](https://pandas.pydata.org/docs/) — Data manipulation
- [Flask Guide](https://flask.palletsprojects.com/) — Web framework
- [scikit-learn Guide](https://scikit-learn.org/stable/documentation.html) — Machine learning
...
- [Groq](https://groq.com/) — Free AI API (no charges)
